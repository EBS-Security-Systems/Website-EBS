    ...
    <div class="container-fluid jumbotron text-center" style="
      ...
      <div class="row">
        ...
        <div class="col-sm-5" style="
                                     ...
                                     ">
          <div class="">
            <img class="img-fluid" src="/images/2º ÌCONE EBS-SYSTEM v2.1.png" style="max-width: 50%;/* margin-inline: 4%; *//* margin-block: 10%; */"><h4 class="text-center" style="
    color: white;
          ...
          <table class="table" style="
            ...
            <tbody>
              <tr>
                ...
                <td>Desde simpes web-pages a verdadeiros sistemas de acesso a informação</td>

              </tr>


              <tr>
                <td>Programação sob medida</td>
                <td>Tenha em mãos um programa de computador do seu jeito</td>
...
<div class="container-fluid text-center jumbotron">
      ...
      <div id="about" class="container-fluid">
        <div class="row">
          <div class="col-sm-4">
            <h2 style="
                       color: white;
                       "><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Tudo isso pra que?</font></font></h2><br>
            <h4 style="
                       color: white;
                       "><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Com o passar do tempo o que era seguro já não é mais! Estudamos desde 2021 sobre como proporcionar segurança na web e estamos trabalhando para tornar isso uma realidade para todos.</font></font></h4><br>                        
            <a href="https://thiagosousa81.wordpress.com/ebs/" target="_blank"><button class="btn btn-default btn-lg" style="width: 100%"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><strong>SAIBA MAIS</strong></font></font></button></a> 
          </div>
          <div class="col-sm-8"><div style="overflow: hidden;max-height: 430px;" class="slideanim slide">
    ...
    <!-- <iframe src="https://ebs-systems.epizy.com/footer.html" width="100%" style="
    border: 0px;
    display: inline;
    margin: 0px;
    height: 142px;
